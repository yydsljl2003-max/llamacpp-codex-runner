...
- NVIDIA 显卡（显存 16GB 以上推荐）
- 内存 32GB 以上

本教程以 RTX 5060 Ti 16GB + 48GB 内存为例。
...
前往 [Node.js 官网](https://nodejs.org/)[citation:1] 下载 LTS（长期支持）版本。推荐使用 18.x 或 20.x LTS 版本。
...
> **注意**：`.codex` 是隐藏文件夹，需要在文件管理器中开启“显示隐藏项目”才能看到。
...
注：Hugging Face是国外网站，有梯子挂梯子，无责尝试将huggingface.co换成[hf-mirror.com](https://hf-mirror.com/unsloth/Qwen3.6-35B-A3B-GGUF)
...
1. 点击 **Code → Download ZIP** 下载源码

2. 解压后，用文本编辑器打开 `Codex模型切换器.py`
